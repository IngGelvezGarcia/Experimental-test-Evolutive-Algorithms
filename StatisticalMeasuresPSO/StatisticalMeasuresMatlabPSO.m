...
% Tag for the tests
CasoIdParm = {'PSO-C1-M1','PSO-C2-M1','PSO-C1-M2','PSO-C2-M2'};
...
for CasoFobj = 1:8;
    ...
    for CasoMaqui = 1 : 2;  
        ...
        for CasoParm = 1 : 2;
            Dato = ['Data','M',num2str(CasoMaqui),'PSO',num2str(CasoParm),'Fobj',num2str(CasoFobj)];
            load(Dato);
            DatFv(:,Indice) = DatF';
            DatTv(:,Indice) = DatT';
            Indice = Indice + 1;
    ...
    % Box plot
    figure
    boxplot(DatFv,'labels',{'DE-C1-M1','DE-C2-M1','DE-C1-M2','DE-C2-M2'})
    ...
    figure
    boxplot(DatTv,'labels',{'DE-C1-M1','DE-C2-M1','DE-C1-M2','DE-C2-M2'})
